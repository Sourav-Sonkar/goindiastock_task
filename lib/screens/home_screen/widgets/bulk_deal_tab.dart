...
class BulkDealTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<BulkDealCubit, CommonStockState>(
          ...
          return ListView(
            ...
            children: [
              Row(
                ...
                children: [
                  ButtonStructure(
                      ...
                      .asButton(
                          onTap: () =>
                              context.read<BulkDealCubit>().changeType(0))
                      .expanded(flex: 1),
                  ...
                  ButtonStructure(
                      ...
                      .asButton(
                          onTap: () =>
                              context.read<BulkDealCubit>().changeType(1))
                      .expanded(flex: 1),
                  const SizedBox(width: 10),
                  ButtonStructure(
                          color: redColor,
                      ...
                      .asButton(
                          onTap: () =>
                              context.read<BulkDealCubit>().changeType(2))
                      .expanded(flex: 1),
                ],
              ...
              Container(
                ...
                child: TextField(
                  onChanged: (value) =>
                      context.read<BulkDealCubit>().getSearchedStock(value),
